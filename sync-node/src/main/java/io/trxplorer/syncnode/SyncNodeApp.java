...
public class SyncNodeApp extends Jooby {
	...
	
	{
		...
		use(new Quartz(SyncNodeJob.class,BlockSyncJob.class,WitnessSyncJob.class,AccountSyncJob.class,ConsolidationJob.class,NodeSyncJob.class,MarketJob.class));
