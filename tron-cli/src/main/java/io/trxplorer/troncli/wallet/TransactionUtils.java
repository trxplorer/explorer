    ...
    try {
      switch (contract.getType()) {
        ...
        case AccountUpdateContract:
            owner = contract.getParameter().unpack(org.tron.protos.Contract.AccountUpdateContract.class).getOwnerAddress();
            break;
        ...
        case WitnessUpdateContract:
            owner = contract.getParameter().unpack(org.tron.protos.Contract.WitnessUpdateContract.class).getOwnerAddress();
            break;
