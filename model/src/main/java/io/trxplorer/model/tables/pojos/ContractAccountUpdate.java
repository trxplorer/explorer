...
public class ContractAccountUpdate implements Serializable {

    private static final long serialVersionUID = 1579845516;
    ...
    public ContractAccountUpdate(ContractAccountUpdate value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ContractAccountUpdate (");
