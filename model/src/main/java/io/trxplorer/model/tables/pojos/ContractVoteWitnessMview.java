...
public class ContractVoteWitnessMview implements Serializable {

    private static final long serialVersionUID = -434931107;
    ...
    public ContractVoteWitnessMview(ContractVoteWitnessMview value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ContractVoteWitnessMview (");
